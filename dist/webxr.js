  ...
  if (t.lkgCanvas == null)
    ...
    return t.lkgCanvas.addEventListener("keydown", (s) => {
      ...
      if (s.buttons & 1 && s.ctrlKey) {
        ...
        y.innerHTML = t.trackballY.toString(), t.trackballY > 0.5 ? -o * 0.01 < 0 && (t.trackballY = t.trackballY - o * 0.01, t.trackballX = t.trackballX - r * 0.01) : t.trackballY < -0.5 && (-o * 0.01 > 0 || -0.5 <= t.trackballY && t.trackballY <= 0.5) && (t.trackballY = t.trackballY - o * 0.01, t.trackballX = t.trackballX - r * 0.01);
