...
function ge() {
  ...
  if (t.lkgCanvas == null)
    ...
    c.appendChild(E), E.style.width = "290px", E.style.whiteSpace = "normal", E.style.color = "rgba(255,255,255,0.7)", E.style.fontSize = "14px", E.style.margin = "5px 0", E.innerHTML = "mousetest23 Click the popup and use WASD, mouse left/right drag, and scroll.";
...
class Re extends me {
  constructor(i, e, n) {
    ...
    e.bindFramebuffer(e.FRAMEBUFFER, p), e.framebufferTexture2D(e.FRAMEBUFFER, e.COLOR_ATTACHMENT0, e.TEXTURE_2D, x, 0), (u.depth || u.stencil) && e.framebufferRenderbuffer(e.FRAMEBUFFER, b.attachment, e.RENDERBUFFER, c), e.bindFramebuffer(e.FRAMEBUFFER, a);
  ...
  onFrameStart(i, e) {
    ...
    if (n.immersive) {
      ...
      for (let b = 0; b < s.numViews; ++b) {
        const p = (b + 0.5) / s.numViews - 0.5, F = Math.tan(s.viewCone * p), w = u * F, E = this.LookingGlassInverseViewMatrices[b] = this.LookingGlassInverseViewMatrices[b] || g.create();
